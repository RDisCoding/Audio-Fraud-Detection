...
class ResNetPreprocessor:
    ...
    def preprocess_dataset(self):
        """Preprocess entire dataset for ResNet with memory-efficient batch processing"""
        print("Starting ResNet preprocessing...")
        ...
        print(f"\nResNet preprocessing completed!")
...
if __name__ == "__main__":
    ...
    preprocessor = ResNetPreprocessor(batch_size=8)  # Reduced from 32 to 8
